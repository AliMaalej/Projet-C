...
create_window1 (void)
{
  ...
  clist1 = gtk_clist_new (8);
  gtk_widget_show (clist1);
  gtk_fixed_put (GTK_FIXED (fixed1), clist1, 16, 48);
  gtk_widget_set_size_request (clist1, 712, 128);
  ...
  label7 = gtk_label_new (_("R\303\251gion"));
  gtk_widget_show (label7);
  gtk_clist_set_column_widget (GTK_CLIST (clist1), 6, label7);

  label8 = gtk_label_new (_("Identifiant"));
  gtk_widget_show (label8);
  gtk_clist_set_column_widget (GTK_CLIST (clist1), 7, label8);

  entry1 = gtk_entry_new ();
  gtk_widget_show (entry1);
  gtk_fixed_put (GTK_FIXED (fixed1), entry1, 32, 200);
  gtk_widget_set_size_request (entry1, 136, 24);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry1), 8226);

  entry2 = gtk_entry_new ();
  gtk_widget_show (entry2);
  gtk_fixed_put (GTK_FIXED (fixed1), entry2, 32, 256);
  gtk_widget_set_size_request (entry2, 136, 24);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry2), 8226);

  entry4 = gtk_entry_new ();
  gtk_widget_show (entry4);
  gtk_fixed_put (GTK_FIXED (fixed1), entry4, 192, 200);
  gtk_widget_set_size_request (entry4, 128, 24);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry4), 8226);

  label9 = gtk_label_new (_("Nom :"));
  gtk_widget_show (label9);
  gtk_fixed_put (GTK_FIXED (fixed1), label9, 32, 176);
  gtk_widget_set_size_request (label9, 41, 17);

  label10 = gtk_label_new (_("Pr\303\251nom :"));
  gtk_widget_show (label10);
  gtk_fixed_put (GTK_FIXED (fixed1), label10, 24, 232);
  gtk_widget_set_size_request (label10, 72, 16);

  label11 = gtk_label_new (_("Age :"));
  gtk_widget_show (label11);
  gtk_fixed_put (GTK_FIXED (fixed1), label11, 24, 288);
  gtk_widget_set_size_request (label11, 49, 17);

  label12 = gtk_label_new (_("CIN :"));
  gtk_widget_show (label12);
  gtk_fixed_put (GTK_FIXED (fixed1), label12, 184, 176);
  gtk_widget_set_size_request (label12, 49, 17);

  label13 = gtk_label_new (_("Sexe :"));
  gtk_widget_show (label13);
  gtk_fixed_put (GTK_FIXED (fixed1), label13, 192, 232);
  gtk_widget_set_size_request (label13, 49, 17);

  label14 = gtk_label_new (_("R\303\251gion :"));
  gtk_widget_show (label14);
  gtk_fixed_put (GTK_FIXED (fixed1), label14, 184, 288);
  gtk_widget_set_size_request (label14, 80, 16);

  label15 = gtk_label_new (_("Role :"));
  gtk_widget_show (label15);
  gtk_fixed_put (GTK_FIXED (fixed1), label15, 336, 176);
  gtk_widget_set_size_request (label15, 49, 17);

  radiobutton1 = gtk_radio_button_new_with_mnemonic (NULL, _("M"));
  gtk_widget_show (radiobutton1);
  gtk_fixed_put (GTK_FIXED (fixed1), radiobutton1, 192, 256);
  gtk_widget_set_size_request (radiobutton1, 48, 24);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton1), radiobutton1_group);
  radiobutton1_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton1));

  radiobutton2 = gtk_radio_button_new_with_mnemonic (NULL, _("F"));
  gtk_widget_show (radiobutton2);
  gtk_fixed_put (GTK_FIXED (fixed1), radiobutton2, 248, 256);
  gtk_widget_set_size_request (radiobutton2, 48, 24);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton2), radiobutton1_group);
  radiobutton1_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton2));

  combobox1 = gtk_combo_box_new_text ();
  gtk_widget_show (combobox1);
  gtk_fixed_put (GTK_FIXED (fixed1), combobox1, 344, 200);
  gtk_widget_set_size_request (combobox1, 70, 25);

  entry7 = gtk_entry_new ();
  gtk_widget_show (entry7);
  gtk_fixed_put (GTK_FIXED (fixed1), entry7, 504, 8);
  gtk_widget_set_size_request (entry7, 96, 32);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry7), 8226);

  button4 = gtk_button_new ();
  gtk_widget_show (button4);
  gtk_fixed_put (GTK_FIXED (fixed1), button4, 608, 368);
  gtk_widget_set_size_request (button4, 114, 32);
  ...
  label19 = gtk_label_new_with_mnemonic (_("Deconnect\303\251"));
  gtk_widget_show (label19);
  gtk_box_pack_start (GTK_BOX (hbox4), label19, FALSE, FALSE, 0);

  button1 = gtk_button_new ();
  gtk_widget_show (button1);
  gtk_fixed_put (GTK_FIXED (fixed1), button1, 32, 368);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), entry8, 520, 240);
  gtk_widget_set_size_request (entry8, 72, 24);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry8), 8226);

  entry9 = gtk_entry_new ();
  gtk_widget_show (entry9);
  gtk_fixed_put (GTK_FIXED (fixed1), entry9, 520, 272);
  gtk_widget_set_size_request (entry9, 72, 24);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry9), 8226);

  label20 = gtk_label_new (_("Homme % :"));
  gtk_widget_show (label20);
  gtk_fixed_put (GTK_FIXED (fixed1), label20, 424, 232);
  gtk_widget_set_size_request (label20, 88, 32);

  label21 = gtk_label_new (_("Femme % :"));
  gtk_widget_show (label21);
  gtk_fixed_put (GTK_FIXED (fixed1), label21, 424, 272);
  gtk_widget_set_size_request (label21, 88, 24);

  button2 = gtk_button_new ();
  gtk_widget_show (button2);
  gtk_fixed_put (GTK_FIXED (fixed1), button2, 616, 192);
  gtk_widget_set_size_request (button2, 106, 32);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), combobox2, 192, 312);
  gtk_widget_set_size_request (combobox2, 130, 25);

  spinbutton1_adj = gtk_adjustment_new (1, 0, 100, 1, 10, 10);
  spinbutton1 = gtk_spin_button_new (GTK_ADJUSTMENT (spinbutton1_adj), 1, 0);
  gtk_widget_show (spinbutton1);
  gtk_fixed_put (GTK_FIXED (fixed1), spinbutton1, 32, 312);
  gtk_widget_set_size_request (spinbutton1, 136, 24);

  button3 = gtk_button_new ();
  gtk_widget_show (button3);
  gtk_fixed_put (GTK_FIXED (fixed1), button3, 608, 8);
  gtk_widget_set_size_request (button3, 112, 32);
